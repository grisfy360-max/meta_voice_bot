...
def text_to_speech(text: str, api_key: str, save_path: str, override_voice: str = None, override_persona: str = None):
    ...
    try:
        ...
        persona = override_persona if override_persona else cfg.get("persona", "You are a helpful assistant.")
